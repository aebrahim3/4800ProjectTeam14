...
CREATE TEMP TABLE staging_course_catalog (
    ...
    program_credential_association TEXT,
    ...
    onet_soc_codes TEXT,
    onet_skill_elements TEXT,
    onet_technology_skills TEXT,
    onet_knowledge_elements TEXT,
    onet_work_activities TEXT,
    onet_task_statements TEXT,
    onet_job_zone INTEGER,
    onet_alignment_notes TEXT,
    sparse_features TEXT,
    course_url TEXT,
    source_url TEXT,
    source_hash TEXT
);
...
SELECT
    ...
    s.prerequisites,
    s.learning_outcomes,
    s.program_credential_association,
    s.credential_type,
    s.certification,
    s.course_level,
    s.delivery_mode,
    s.campus,
    s.term_availability,
    COALESCE(NULLIF(s.onet_soc_codes, ''), '[]')::jsonb,
    COALESCE(NULLIF(s.onet_skill_elements, ''), '[]')::jsonb,
    COALESCE(NULLIF(s.onet_technology_skills, ''), '[]')::jsonb,
    COALESCE(NULLIF(s.onet_knowledge_elements, ''), '[]')::jsonb,
    COALESCE(NULLIF(s.onet_work_activities, ''), '[]')::jsonb,
    COALESCE(NULLIF(s.onet_task_statements, ''), '[]')::jsonb,
    s.onet_job_zone,
    s.onet_alignment_notes,
    COALESCE(NULLIF(s.sparse_features, ''), '{}')::jsonb,
    s.course_url,
    s.source_url,
