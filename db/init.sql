...
CREATE TABLE courses (
    ...
    campus VARCHAR(100),
    term_availability VARCHAR(100),
    onet_soc_codes JSONB,
    onet_skill_elements JSONB,
    onet_technology_skills JSONB,
    onet_knowledge_elements JSONB,
    onet_work_activities JSONB,
    onet_task_statements JSONB,
    onet_job_zone INTEGER,
    onet_alignment_notes TEXT,
    sparse_features JSONB DEFAULT '{}'::jsonb,
    course_url TEXT,
    source_url TEXT,
